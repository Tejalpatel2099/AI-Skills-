...
> **Invoke in Codex CLI:** type `$debug` (or just describe the task and Codex triggers it automatically). Install path: `~/.codex/skills/debug/SKILL.md` (personal) or `.codex/skills/debug/SKILL.md` (per-repo).
