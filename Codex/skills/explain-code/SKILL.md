...
> **Invoke in Codex CLI:** type `$explain-code` (or just describe the task and Codex triggers it automatically). Install path: `~/.codex/skills/explain-code/SKILL.md` (personal) or `.codex/skills/explain-code/SKILL.md` (per-repo).
