...
> **Invoke in Codex CLI:** type `$document-code` (or just describe the task and Codex triggers it automatically). Install path: `~/.codex/skills/document-code/SKILL.md` (personal) or `.codex/skills/document-code/SKILL.md` (per-repo).
