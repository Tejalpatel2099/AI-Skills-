...
> **Invoke in Codex CLI:** type `$write-tests` (or just describe the task and Codex triggers it automatically). Install path: `~/.codex/skills/write-tests/SKILL.md` (personal) or `.codex/skills/write-tests/SKILL.md` (per-repo).
