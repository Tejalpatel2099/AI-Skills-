...
> **Invoke in Codex CLI:** type `$refactor` (or just describe the task and Codex triggers it automatically). Install path: `~/.codex/skills/refactor/SKILL.md` (personal) or `.codex/skills/refactor/SKILL.md` (per-repo).
