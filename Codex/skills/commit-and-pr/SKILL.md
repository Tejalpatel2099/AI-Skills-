...
> **Invoke in Codex CLI:** type `$commit-and-pr` (or just describe the task and Codex triggers it automatically). Install path: `~/.codex/skills/commit-and-pr/SKILL.md` (personal) or `.codex/skills/commit-and-pr/SKILL.md` (per-repo).
