...
> **Invoke in Codex CLI:** type `$code-review` (or just describe the task and Codex triggers it automatically). Install path: `~/.codex/skills/code-review/SKILL.md` (personal) or `.codex/skills/code-review/SKILL.md` (per-repo).
